...
#                                                                             
# PROGRAMMER:Sandeep chakka
# DATE CREATED:10-09-2025                                 
# REVISED DATE:13-09-2025 
        ...
        if (n_correct_dogs + n_correct_notdogs) != n_images:
            ...
            for key in results_dic:
                if sum(results_dic[key][3:5]) == 1:
                    print(f"Pet Label: {results_dic[key][0]:>20}  "
                          f"Classifier Label: {results_dic[key][1]:>30}")
    if print_incorrect_breed:
        n_correct_dogs = results_stats_dic['n_correct_dogs']
        n_correct_breed = results_stats_dic['n_correct_breed']
        if n_correct_dogs != n_correct_breed:
            print("\nIncorrectly Classified Breeds of Dogs:")
            for key in results_dic:
